      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service, index) => (
          <motion.div
            ...
            className="group p-8 rounded-3xl bg-background border border-border hover:border-accent/50 hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-24 h-24 bg-accent/5 rounded-bl-full translate-x-12 -translate-y-12 group-hover:translate-x-8 group-hover:-translate-y-8 transition-transform" />
            
            <div className="p-3 bg-secondary rounded-2xl w-fit mb-6 text-accent group-hover:scale-110 transition-transform">
            ...
            <button className="text-sm font-bold flex items-center gap-2 text-accent group/btn">
